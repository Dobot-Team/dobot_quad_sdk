...
def main():
    ...
    # 6) 两个复合平衡动作
    robot.dynamic_pose(3.0, roll_deg=10.0, pitch_deg=10.0, yaw_deg=15.0, height_m=-0.05)
    robot.static_pose(3.0, roll_deg=10.0, pitch_deg=10.0, yaw_deg=15.0, height_m=-0.05)
